...
import { b as useNuxtApp, aa as asyncDataDefaults, ab as createError$1, c as useRuntimeConfig, ac as useRequestEvent } from './server.mjs';
import { M as withLeadingSlash, o as joinURL, I as withoutTrailingSlash, N as withBase, J as hash } from '../runtime.mjs';
import { u as useContentPreview } from './preview-BQ7D6czi.mjs';
...
const createQueryFetch = () => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import('./client-db--C8iN4xp.mjs').then((m) => m.useContentDatabase());
...
//# sourceMappingURL=query-6cATSKu8.mjs.map
