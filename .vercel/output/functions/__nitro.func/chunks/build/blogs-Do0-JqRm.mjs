      ...
      if (_push2) {
        _push2(ssrRenderComponent(VRow, {
          ...
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<p${_scopeId2}>This page will be displayed at the /blogs route.</p>`);
            } else {
              return [createVNode("p", null, "This page will be displayed at the /blogs route.")];
            }
          }),
          _: 1
        }, _parent2, _scopeId));
        ...
        return [createVNode(VRow, {
          ...
          default: withCtx(() => [createVNode("p", null, "This page will be displayed at the /blogs route.")]),
          _: 1
        })];
      }
    }),
...
//# sourceMappingURL=blogs-Do0-JqRm.mjs.map
